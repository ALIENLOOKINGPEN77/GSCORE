...
import { AlertCircle, FileCheck, Trash2, Check, X } from "lucide-react";
        ...
        <div className="bg-white border rounded-lg shadow-sm mb-6">
          <div className="p-6 border-b border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-xl font-semibold text-gray-900">Órdenes Pendientes</h2>
                <p className="text-sm text-gray-600 mt-1">
                  {orders.length} orden(es) esperando confirmación
                  {selectedOrders.size > 0 && ` • ${selectedOrders.size} seleccionada(s)`}
                </p>
              </div>
